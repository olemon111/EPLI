...
#define PREF_2(cmd, mem_var) \
     PREF_1(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + (CACHE_LINE_SIZE)))

#define PREF_3(cmd, mem_var) \
     PREF_2(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 2 * (CACHE_LINE_SIZE)))

#define PREF_4(cmd, mem_var) \
     PREF_3(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 3 * (CACHE_LINE_SIZE)))

#define PREF_5(cmd, mem_var) \
     PREF_4(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 4 * (CACHE_LINE_SIZE)))

#define PREF_6(cmd, mem_var) \
     PREF_5(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 5 * (CACHE_LINE_SIZE)))

#define PREF_7(cmd, mem_var) \
     PREF_6(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 6 * (CACHE_LINE_SIZE)))

#define PREF_8(cmd, mem_var) \
     PREF_7(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 7 * (CACHE_LINE_SIZE)))

#define PREF_9(cmd, mem_var) \
     PREF_8(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 8 * (CACHE_LINE_SIZE)))

#define PREF_10(cmd, mem_var) \
     PREF_9(cmd, mem_var);    \
     cmd(*((char *)&(mem_var) + 9 * (CACHE_LINE_SIZE)))

#define PREF_11(cmd, mem_var) \
     PREF_10(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 10 * (CACHE_LINE_SIZE)))

#define PREF_12(cmd, mem_var) \
     PREF_11(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 11 * (CACHE_LINE_SIZE)))

#define PREF_13(cmd, mem_var) \
     PREF_12(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 12 * (CACHE_LINE_SIZE)))

#define PREF_14(cmd, mem_var) \
     PREF_13(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 13 * (CACHE_LINE_SIZE)))

#define PREF_15(cmd, mem_var) \
     PREF_14(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 14 * (CACHE_LINE_SIZE)))

#define PREF_16(cmd, mem_var) \
     PREF_15(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 15 * (CACHE_LINE_SIZE)))

#define PREF_17(cmd, mem_var) \
     PREF_16(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 16 * (CACHE_LINE_SIZE)))

#define PREF_18(cmd, mem_var) \
     PREF_17(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 17 * (CACHE_LINE_SIZE)))

#define PREF_19(cmd, mem_var) \
     PREF_18(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 18 * (CACHE_LINE_SIZE)))

#define PREF_20(cmd, mem_var) \
     PREF_19(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 19 * (CACHE_LINE_SIZE)))

#define PREF_21(cmd, mem_var) \
     PREF_20(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 20 * (CACHE_LINE_SIZE)))

#define PREF_22(cmd, mem_var) \
     PREF_21(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 21 * (CACHE_LINE_SIZE)))

#define PREF_23(cmd, mem_var) \
     PREF_22(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 22 * (CACHE_LINE_SIZE)))

#define PREF_24(cmd, mem_var) \
     PREF_23(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 23 * (CACHE_LINE_SIZE)))

#define PREF_25(cmd, mem_var) \
     PREF_24(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 24 * (CACHE_LINE_SIZE)))

#define PREF_26(cmd, mem_var) \
     PREF_25(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 25 * (CACHE_LINE_SIZE)))

#define PREF_27(cmd, mem_var) \
     PREF_26(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 26 * (CACHE_LINE_SIZE)))

#define PREF_28(cmd, mem_var) \
     PREF_27(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 27 * (CACHE_LINE_SIZE)))

#define PREF_29(cmd, mem_var) \
     PREF_28(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 28 * (CACHE_LINE_SIZE)))

#define PREF_30(cmd, mem_var) \
     PREF_29(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 29 * (CACHE_LINE_SIZE)))

#define PREF_31(cmd, mem_var) \
     PREF_30(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 30 * (CACHE_LINE_SIZE)))

#define PREF_32(cmd, mem_var) \
     PREF_31(cmd, mem_var);   \
     cmd(*((char *)&(mem_var) + 31 * (CACHE_LINE_SIZE)))
...
#define LOOP_PREF(cmd, mem_varp, nline)               \
     {                                                \
          ...
          for (; _p < _pend; _p += (CACHE_LINE_SIZE)) \
               cmd(*_p);                              \
     }
